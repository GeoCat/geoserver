        ...
        stage('Build') {
            steps {
                withMaven(
                    ...
                    sh "export PATH=${MVN_CMD_DIR}:${PATH} && mvn -f ./geoserver/src/community/pom.xml -B -Dorg.slf4j.simpleLogger.log.org.apache.maven.cli.transfer.Slf4jMavenTransferListener=warn install -Pgeopkg,ogcapi -DskipTests"
