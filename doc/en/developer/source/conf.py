...
extlinks = { 
    ...
    'developer': ('http://docs.geoserver.org/2.27.x/en/developer/%s', None),
    'docguide': ('http://docs.geoserver.org/2.27.x/en/docguide/%s', None),
    ...
    'api': ('http://docs.geoserver.org/2.27.x/en/api/#1.0.0/%s', None)
}
